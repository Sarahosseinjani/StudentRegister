...
import com.example.hp.studentregister.Student.AddNewStudentActivity;
import com.example.hp.studentregister.Student.Student;
import com.example.hp.studentregister.Student.StudentDataAdapter;
import com.example.hp.studentregister.db.StudentAppDatabase;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,ItemTouchHelper.LEFT) {
           ...
           //when swipe to left  student will delete
            @Override
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==NEW_STUDENT_ACTIVITY_REQUEST_CODE && resultCode==RESULT_OK){
             //Get information that transfer from register activity
